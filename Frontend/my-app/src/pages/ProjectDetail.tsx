...
//         }}
//       >
//         <img src={`http://localhost:5000/${project.images[0]}`} alt={project.title} draggable={false} className="w-full h-auto md:absolute md:inset-0 md:h-full md:object-cover" />
//       </div>
...
//               {project.pdfFile && (
//                 <a href={`http://localhost:5000/${project.pdfFile}`} download className="inline-flex items-center gap-2 px-5 py-3 text-gray-600 hover:text-gray-900 text-md font-medium">
...
//             return (
//               <div key={idx} onClick={() => setSelectedIndex(idx + 1)} className={`overflow-hidden cursor-pointer bg-gray-50 ${isLandscape ? "md:col-span-2" : "md:col-span-1"} md:h-[550px] sm:h-[320px]`}>
//                 <img src={`http://localhost:5000/${img}`} alt={`${project.title} ${idx}`} className="w-full h-auto md:h-full md:object-fill object-contain" />
//               </div>
//             );
//           })}
//         </div>
...
//         >
//           <div className="relative w-full h-full flex items-center justify-center">
//             <img src={`http://localhost:5000/${project.images[selectedIndex]}`} className="object-contain max-w-full max-h-full transition-transform" style={{ transform: `scale(${zoom})` }} />
