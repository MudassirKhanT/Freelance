...
//                 <div className="grid grid-cols-1 md:grid-cols-2 mt-6 md:mt-8">
//                   {/* LEFT : STUDIO */}
//                   <div
//                     className="
...
//                       "
//                         style={{
//                           fontSize: studio.description.length > 450 ? "0.9rem" : studio.description.length > 300 ? "1rem" : studio.description.length > 150 ? "1.05rem" : "1.15rem",
//                           lineHeight: "1.6rem",
//                         }}
//                       >
//                         {studio.description}
                  ...
                  >
                    <div className="max-w-xl mx-auto md:mx-0 text-center md:text-left">
                      ...
                      <p
                        ...
                        "
                        style={{
                          fontSize: studio.description.length > 450 ? "1.1rem" : studio.description.length > 300 ? "1.5rem" : studio.description.length > 150 ? "1.05rem" : "1.15rem",
                          lineHeight: "1.6rem",
                        }}
                      >
                        {studio.description}
